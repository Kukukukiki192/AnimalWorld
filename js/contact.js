...
window.onload=function(){
    ...
    if(document.getElementById("contact")!=null) {
        document.getElementById("contact").onsubmit = function () {
            ...
            var sInterest = document.getElementById("interest").value;//获得爱好选项值
            //获得性别选项值
            ...
            document.getElementById("submitmessage").innerHTML = "<strong>姓名：" + sName
                    + "<br>性别：" + sSex + "<br>年龄范围：" + sAge + "<br>爱好：" + sInterest + "<br>电子邮件："
                    + sDzyj + "<br>固定电话：" + sTelephone + "<br>公司：" + sCompany + "</strong>";
            return false;//不提交表单
            // return true;//提交表单
        }
    }
